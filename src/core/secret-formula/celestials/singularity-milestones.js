...
export const singularityMilestones = {
  ...
  darkMatterMult: {
    ...
    limit: Infinity,
    description: "Nigga production multiplier",
  ...
  darkDimensionCostReduction: {
    ...
    limit: Infinity,
    description: "Nigga Dimension upgrades are cheaper",
  ...
  darkDimensionIntervalReduction: {
    ...
    increaseThreshold: 20,
    limit: Infinity,
    description: "Nigga Dimension interval decrease",
  ...
  improvedAscensionDM: {
    ...
    limit: Infinity,
    description: "Ascension affects Nigga production more",
  ...
  ascensionIntervalScaling: {
    ...
    repeat: 2400,
    limit: 8,
    description: "Nigga Dimensions Ascension increases the interval less",
  ...
  darkDimensionAutobuyers: {
    ...
    repeat: 170,
    limit: 4,
    description: "Nigga Dimension Autobuyers",
  ...
  darkFromTesseracts: {
    ...
    repeat: 0,
    limit: 1,
    description: "Tesseracts boost Nigga and Dark Energy production",
  ...
  multFromInfinitied: {
    ...
    repeat: 0,
    limit: 1,
    description: "Infinities boost Nigga and Dark Energy production",
  ...
  darkFromGlyphLevel: {
    ...
    repeat: 0,
    limit: 1,
    description: "Boost Nigga and Dark Energy production based on highest Glyph level",
  ...
  darkFromDM4: {
    ...
    repeat: 0,
    limit: 1,
    description: "4th Nigga Dimension amount boosts Nigga and Dark Energy gain",
  ...
  darkFromGamespeed: {
    ...
    repeat: 0,
    limit: 1,
    description: "Game speed boosts Nigga and Dark Energy production",
  ...
  darkFromDilatedTime: {
    ...
    repeat: 0,
    limit: 1,
    description: "Dilated Time boosts Nigga production",
